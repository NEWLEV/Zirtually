...
_Focus: Stabilize the existing SPA, fix broken routes, and implement basic persistence._
...
_Focus: Moving from "Fake" to "Real" backend and security._
...
_Focus: Premium feel, accessibility, and AI assistant hardening._
...
_Focus: Collaboration and data at scale._
...
2.  **Service Layer Dependency:** Moving to a DB _requires_ the Service Layer to be finished first to prevent massive UI churn.
