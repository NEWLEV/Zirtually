...
export const ZirtuallyLogo: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      d="M8 12h16M8 12l8 8m-8-8l8-4m0 12l8-8m-8 8l8 4"
      stroke="white"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ClockIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 8v4l3 2m6-6a9 9 0 11-18 0 9 9 0 0118 0z"
    />
  </svg>
);
...
export const TrophyIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806"
    />
  </svg>
);
...
export const AwardIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 15l-2 5L12 18l2 2-2-5zm0-10a5 5 0 100 10 5 5 0 000-10z"
    />
  </svg>
);
...
export const RocketIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.63 8.41a14.98 14.98 0 00-6.16 12.12 14.98 14.98 0 0012.12-6.16z"
    />
  </svg>
);
...
export const MicrophoneIcon: React.FC<IconProps> = ({ className }) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M19 10v2a7 7 0 01-14 0v-2m14 0a7 7 0 01-14 0m14 0v2m-7 8v3m-3 0h6"
    />
  </svg>
);
...
export const Icon: React.FC<GenericIconProps> = ({ name, className = '', size = 20 }) => {
  const iconMap: Record<string, React.FC<IconProps>> = {
    ...
    audit: AuditLogIcon,
    performance: PerformanceReviewIcon,
    skills: SkillMatrixIcon,
    documents: DocumentManagementIcon,
    journey: MyJourneyIcon,
    credentialing: CredentialingIcon,
    wellness: WellnessIcon,
    profile: ProfileIcon,
    notifications: NotificationsIcon,
    settings: SettingsIcon,
    offboarding: OffboardingIcon,
    clock: ClockIcon,
    ...
    'alert-circle': AlertTriangleIcon, // fallback
    ...
    edit: EditIcon,
    upload: ArrowTrendingUpIcon, // placeholder for upload
    'upload-cloud': CloudIcon, // placeholder
    'folder-x': FolderIcon, // placeholder
    image: DocumentIcon,
    table: DocumentIcon,
    ...
    lock: ShieldIcon,
    search: SearchIcon,
    'share-2': UsersIcon, // placeholder
    eye: UsersIcon, // placeholder
    mic: MicrophoneIcon,
  };

  const IconComponent = iconMap[name.toLowerCase()] || StarIcon;
  return (
    <span
