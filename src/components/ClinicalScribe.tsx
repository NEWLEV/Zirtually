...
const ClinicalScribe: React.FC<ClinicalScribeProps> = ({
  user: _user,
    ...
    <div className="space-y-6">
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg dark:bg-yellow-900/50 dark:border-yellow-600">
        <p className="text-sm text-yellow-800 dark:text-yellow-300">
          <span className="font-bold">Important:</span> Do not record any Patient Health Information
          (PHI) or other sensitive data with this tool. This feature is intended for general,
          non-PHI administrative notes and reminders.
        </p>
      </div>
      ...
      <Card>
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-4 text-lg font-medium text-gray-700 dark:text-dark-text-secondary">
