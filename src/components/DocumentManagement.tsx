...
const MOCK_DOCUMENTS: Document[] = [
  ...
  },
  {
    ...
    status: 'current',
    description:
      'Guide to enrolling in company benefits including health, dental, vision, and 401k.',
    version: 2,
    downloadCount: 189,
    sharedWith: 'everyone',
  },
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-amber-700 dark:text-amber-300 mt-1">
                {outdatedDocs.length} document(s) are marked as outdated and may need to be reviewed
                or updated.
              </p>
            </div>
            <Button size="sm" variant="secondary" onClick={() => setFilterStatus('outdated')}>
              Review
            </Button>
          </div>
        </Card>
          ...
          <Card variant="bordered" className="p-4">
            ...
            <div className="space-y-2">
              {FOLDERS.map(folder => (
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-lg bg-gradient-to-br ${getFolderColor(folder.color)} flex items-center justify-center`}
                  >
              ...
              {filteredDocuments.map(doc => (
                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    <div
                      className={`w-12 h-12 rounded-lg flex items-center justify-center ${getFileColor(doc.type)}`}
                    >
                    ...
                    >
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-8 h-8 rounded flex items-center justify-center ${getFileColor(doc.type)}`}
                          >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium ${getStatusBadge(doc.status)}`}
                        >
                          {doc.status.replace('_', ' ')}
                        </span>
                      </td>
        ...
        >
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div
                className={`w-16 h-16 rounded-lg flex items-center justify-center ${getFileColor(selectedDocument.type)}`}
              >
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span
                    className={`px-2 py-0.5 rounded text-xs font-medium ${getStatusBadge(selectedDocument.status)}`}
                  >
