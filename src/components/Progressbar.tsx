...
const ProgressBar: React.FC<ProgressBarProps> = ({
  ...
  const variantClasses = {
    ...
    gradient: 'bg-gradient-to-r from-action-primary via-action-secondary to-focus-ring',
  ...
  return (
    <div className={`relative ${className}`}>
      <div
        className={`w-full bg-gray-200 dark:bg-slate-700 rounded-full overflow-hidden ${sizeClasses[size]}`}
      >
        <div
